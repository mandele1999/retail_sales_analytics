...
def plot_success_rates(metrics):
    ...
    plt.savefig('success_rates.png')  # Save the plot
...
def plot_trends(metrics):
    ...
    plt.legend()
    plt.savefig('trends.png')  # Save the plot
    plt.close()  # Close the plot to free memory

def generate_report(report_filepath):
    with open(report_filepath, 'w') as f:
        f.write("Automated ETL Pipeline Report\n")
        f.write("=" * 30 + "\n\n")
        f.write("Success Rates:\n")
        f.write("![Success Rates](success_rates.png)\n\n")
        f.write("Trends Over Time:\n")
        f.write("![Trends](trends.png)\n\n")
...
if __name__ == "__main__":
    ...
    report_filepath = 'etl_report.txt'
